...
const ClickShow = ({ children, Component, className, childClassName, onChange, options }) => {
	...
	return (
		<div className={compositeClassName} onClick={handleToggle}>
			...
			<BlockContainer className={clsx("ClickShow_Element", childClassName, { "_sl": isShow && childClassName })}>
				<Component className="ClickShow_Element_Component" handleChange={onChange} options={options} />
			</BlockContainer>
		</div>
	);
};
